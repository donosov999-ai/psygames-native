...
///
/// 🔴 СЕМЬ, А НЕ ЧЕТЫРЕ — И ТРИ ПОСЛЕДНИХ ВЫБРАНЫ ЗАМЕРОМ, А НЕ НА ГЛАЗ.
/// Лестница доходит до шести шаров (`tool/export_tol_levels.dart`): у
/// конфигурации 4-4-3 диаметр 16 ходов против 14 у четырёх шаров. Пятый и
/// шестой цвет подбирались по ΔE76 между ТЁМНЫМИ оттенками всех пар:
///   фиолет+оранжевый — мин ΔE 21,9 (Y-O): оранжевый слишком близок к янтарю;
///   фиолет+бирюза    — мин ΔE 34,4 (B-P): фиолетовый близок к синему;
///   МАДЖЕНТА+БИРЮЗА  — мин ΔE 41,3, и узкое место это пара R-Y, которая в игре
///                      УЖЕ ЕСТЬ. То есть новая пара не становится слабым звеном.
/// Буквы взяты по цвету (M — magenta, C — cyan), чтобы подпись на шаре не врала.
///
/// 🔴 СЕДЬМОЙ (`P`, розовый #DB2777) — 25.09.2026, вместе с семишаровыми
/// ступенями (решение Дениса «растить дальше новой осью»; предел плана у
/// конфигурации 4-4-3 с семью шарами — 21 ход против 16 у шести).
/// Замер ΔE76 тёмных оттенков, двенадцать кандидатов, у каждого взято
/// МИНИМАЛЬНОЕ расстояние до шести нынешних:
///   розовый #DB2777 — 46,5 (узкое место P-R)   ← взят
///   фуксия  #9D174D — 46,2 · коричневый #78350F — 42,2
///   изумруд #047857 — 34,4 · тёмно-синий #1E3A8A — 34,2 · фиолет #7C3AED — 31,8
///   грифель #475569 — 31,0 · лайм #65A30D — 28,1 · бирюзово-зелёный #0F766E — 26,9
///   оранжевый #EA580C — 21,9 · индиго #4338CA — 21,0 · тёмный янтарь #B45309 — 17,9
/// ⚠️ Критерий не «побольше», а «НЕ СТАНОВИТСЯ УЗКИМ МЕСТОМ»: нынешний минимум
/// среди шести — пара R-Y, 41,3. Розовый (46,5), фуксия (46,2) и коричневый
/// (42,2) его проходят, остальные девять сделали бы слабым звеном СЕБЯ.
const Map<String, List<Color>> ballColors = {
  ...
  'M': [Color(0xFFF0ABFC), Color(0xFFA21CAF)],
  'C': [Color(0xFF67E8F9), Color(0xFF0891B2)],
  'P': [Color(0xFFF9A8D4), Color(0xFFDB2777)],
};
