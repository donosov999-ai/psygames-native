...
/// и их цвета подобраны замером ΔE в `board.dart` — не переименовывать порознь.
const _colours = ['R', 'G', 'B', 'Y', 'M', 'C'];
...
///   L1–L7   3 шара 3-2-1, план 2…8   (диаметр 8 — отрезок выбран досуха)
///   L8–L13  4 шара 4-3-1, план 9…14  (диаметр 14 — тоже досуха)
///   L14–L20 6 шаров 4-4-3, план 10…16 (диаметр 16)
///
