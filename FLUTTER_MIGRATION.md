...
| ✅ | `corsi` | psygames-span-claude-mac | 24.09 | нативно, перехват в гибриде; правила сверены с эталонами живого TS на L1…L60, партия играется пробой нажатиями, доска не вылезает за поле на 360×640 |
