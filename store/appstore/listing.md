...
## 1. Базовые поля
- **Name (≤30):** `PsyGames`
- **Subtitle (≤30):** EN `75 brain training games` · RU `75 игр для тренировки мозга`
...
- **EN:** `New: a language warm-up that mixes two foreign languages round by round. 75 cognitive games on real neuropsychology. 12 languages, offline, no ads.`
- **RU:** `Новое: языковая зарядка — два иностранных вперемешку, раунд за раундом. 75 когнитивные игры на реальных парадигмах. 12 языков, офлайн, без рекламы.`

## 3. Description (EN — primary)
```
PsyGames is 75 cognitive training games built on validated neuropsychological paradigms — N-back, Stroop, Corsi, Trail Making, SET, Tower of London and more.
...
WHAT'S INSIDE
• 75 games across 6 categories: Memory, Attention, Logic, Intuition, Speed & Control, Recovery
...
```
PsyGames — это 75 когнитивных тренажёров на основе валидированных нейропсихологических парадигм: N-back, Струп, Корси, Trail Making, SET, Башня Лондона и другие.
...
ЧТО ВНУТРИ
• 75 игр в 6 категориях: Память, Внимание, Логика, Интуиция, Скорость и Контроль, Восстановление
...
1. Главный экран — категории + карточки игр (профиль ODV999/NZT).
   ...
   а он равен `GAMES.length` = 75 и считает три карточки-развилки за тренажёры. В текстах
   карточки стоит 75 — упражнения без развилок, как считает онбординг. Пока долг в
...
- **EN:** `First release. 75 cognitive games, morning & evening complexes, 12 profiles, cognitive assessment, 12 languages, fully offline.`
- **RU:** `Первый релиз. 75 когнитивных игр, утренние и вечерние комплексы, 12 профилей, оценка профиля, 12 языков, полностью офлайн.`
