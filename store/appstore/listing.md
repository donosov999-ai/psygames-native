...
## 1. Базовые поля
- **Name (≤30):** `PsyGames`
- **Subtitle (≤30):** EN `68 brain training games` · RU `68 игр для тренировки мозга`
...
- **EN:** `68 cognitive games built on real neuropsychology — train memory, attention, logic and speed, and watch your progress. 12 languages, offline, no ads.`
- **RU:** `68 когнитивных игр на реальных нейропсих-парадигмах — тренируй память, внимание, логику и скорость, отслеживай прогресс. 12 языков, офлайн, без рекламы.`

## 3. Description (EN — primary)
```
PsyGames is 68 cognitive training games built on validated neuropsychological paradigms — N-back, Stroop, Corsi, Trail Making, SET, Tower of London and more.
...
WHAT'S INSIDE
• 68 games across 6 categories: Memory, Attention, Logic, Intuition, Speed & Control, Recovery
...
```
PsyGames — это 68 когнитивных тренажёров на основе валидированных нейропсихологических парадигм: N-back, Струп, Корси, Trail Making, SET, Башня Лондона и другие.
...
ЧТО ВНУТРИ
• 68 игр в 6 категориях: Память, Внимание, Логика, Интуиция, Скорость и Контроль, Восстановление
...
1. Главный экран — категории + карточки игр (профиль ODV999/NZT).
   ...
   карточки стоит 68 — упражнения без развилок, как считает онбординг. Пока долг в
...
- **EN:** `First release. 68 cognitive games, morning & evening complexes, 12 profiles, cognitive assessment, 12 languages, fully offline.`
- **RU:** `Первый релиз. 68 когнитивных игр, утренние и вечерние комплексы, 12 профилей, оценка профиля, 12 языков, полностью офлайн.`
