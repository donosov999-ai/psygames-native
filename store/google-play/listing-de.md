...
```
Beim ersten Mal merken und dranbleiben. 70 Übungen, offline, ohne Werbung
```
73 символов · рекомендую

Запасной:
```
Gedächtnis, Konzentration, Tempo. 70 Übungen. Offline, ohne Werbung
```
68 символов
...
PsyGames ist Gehirnjogging: Denkspiele, Rätsel und 70 Übungen für Gedächtnis, Aufmerksamkeit und Logik. Kein weiterer IQ-Test, sondern Training mit messbarem Ergebnis.
...
WAS DRIN IST
• 70 Übungen für Gedächtnis, Aufmerksamkeit, Logik, Tempo und Kontrolle
