...
```
Beim ersten Mal merken und dranbleiben. 65 Übungen, offline, ohne Werbung
```
73 символов · рекомендую

Запасной:
```
Gedächtnis, Konzentration, Tempo. 65 Übungen. Offline, ohne Werbung
```
67 символов
...
PsyGames ist Gehirnjogging: Denkspiele, Rätsel und 65 Übungen für Gedächtnis, Aufmerksamkeit und Logik. Kein weiterer IQ-Test, sondern Training mit messbarem Ergebnis.
...
WAS DRIN IST
• 65 Übungen für Gedächtnis, Aufmerksamkeit, Logik, Tempo und Kontrolle
