...
```
Memoria, concentración y rapidez mental. 72 ejercicios offline, sin anuncios
```
...
PsyGames es entrenamiento cerebral: juegos mentales, rompecabezas y 72 ejercicios de memoria, atención y lógica. No es otro test para adivinar tu IQ: es práctica con resultados visibles.
...
QUÉ INCLUYE
• 72 ejercicios de memoria, atención, lógica, velocidad y control
