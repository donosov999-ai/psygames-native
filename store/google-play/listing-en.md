...
```
Remember it the first time and stop drifting. 74 exercises, offline, no ads
```
75 символов · рекомендую

Запасной:
```
Memory, focus, thinking speed. 74 exercises. Offline, no ads
```
60 символов
...
PsyGames is brain training and brain games: 74 exercises and puzzles for memory, attention, logic and thinking speed. Not another "test your IQ", but training with results you can measure.
