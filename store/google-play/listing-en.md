...
```
Remember it the first time and stop drifting. 63 exercises, offline, no ads
```
75 символов · рекомендую

Запасной:
```
Memory, focus, thinking speed. 63 exercises. Offline, no ads
```
60 символов
...
WHAT'S INSIDE
• 63 exercises for memory, attention, logic, speed and control
