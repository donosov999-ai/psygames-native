...
/**
 * Потолок долга. Замер 23.08.2026 ПО ОБЛАСТИ SCOPE НИЖЕ — это важно: снятый
 * другой командой (`expo lint`) он отличается на единицы, и подставить его сюда
 * значит получить красное на ровном месте. Опускать при каждой чистке, не поднимать.
 */
const CEILING = { errors: 602, warnings: 422 };
