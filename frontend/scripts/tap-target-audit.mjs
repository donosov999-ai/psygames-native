...
const FIELD_DEBT = {
  ...
  '/games/trail-making':   { max: 6,   why: 'ФИЗИКА: узлы тропинки 44×44 расставлены по площади поля, укрупнение сократит длину маршрута' },
  '/games/stroop-emotional': { max: 4, why: 'ОТСТУПЫ: кнопкам ответа не хватает 3pt по высоте (45 вместо 48) — чинится padding' },
  '/games/rmet':           { max: 4,   why: 'ОТСТУПЫ: кнопкам ответа не хватает 3pt по высоте (45 вместо 48) — чинится padding' },
  '/games/hanoi':          { max: 1,   why: 'ОТСТУПЫ: «Отменить» 134×44, не хватает 4pt по высоте' },
  '/games/tower-london':   { max: 1,   why: 'ОТСТУПЫ: «Отменить» 134×44, не хватает 4pt по высоте' },
  '/games/math-sprint':    { max: 1,   why: 'ОТСТУПЫ: «Проверить» 184×46, не хватает 2pt по высоте' },
  '/games/set-game':       { max: 1,   why: 'ОТСТУПЫ: «💡 Подсказка» 130×39, не хватает 9pt по высоте' },
  '/games/sudoku':         { max: 1,   why: 'ОТСТУПЫ: ссылка «правила ⓘ» 77×23 — мелкая по замыслу, но фокусируется как кнопка' },
  '/games/prl':            { max: 1,   why: 'ОТСТУПЫ: строка-подсказка «Угадывать не нужно» 323×23 фокусируется как элемент, кнопкой не является' },
};
