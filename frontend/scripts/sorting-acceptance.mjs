/* sorting-acceptance · VER 1 · 16.09.2026 */
/**
...
const OUT = args.out ?? '/Users/denisonosov/dev/psygames/sorting-chat/art/shots/приёмка';
...
const СТРЕЛКА = /(^|\s)(Вверх|Вниз|Влево|Вправо|Up|Down|Left|Right|↑|↓|←|→)(\s|$)|стрелк|Ход вверх|Ход вниз/i;
