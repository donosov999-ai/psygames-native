/* psygames-game-cloze · VER 1 · 19.08.2026 */
/**
...
// Было зашито '#FFF' — контраст 2.15 (норма AA 4.5), стало 4.61.
      ...
      <ScrollView style={styles.configScroll} showsVerticalScrollIndicator={false}>
        <View style={styles.configContainer}>
          <LinearGradient colors={GRADIENT as [string, string]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.configCard}>
            <Ionicons name="create" size={48} color={ON_GRAD.color} />
            <Text style={[styles.configTitle, { color: ON_GRAD.color }]}>{t('cloze')}</Text>
            <Text style={[styles.configDesc, { color: ON_GRAD_SOFT }]}>{t('clozeDesc')}</Text>
          </LinearGradient>
