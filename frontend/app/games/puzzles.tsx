/* psygames-game-puzzles · VER 12 · 17.09.2026 */
/**
...
export default function PuzzlesScreen() {
  ...
  */
   ...
   */
  const рядЗначками = ЦВЕТ_ЛИНИИ[имяРежима] !== undefined && ВТОРОЕ_ДЕЙСТВИЕ.has(имяРежима);
  /**
        ...
        <View style={styles.сцена}>
          ...
          */}
          ...
          {ВТОРОЕ_ДЕЙСТВИЕ.has(имяРежима) ? (
            ...
            {/* «Где ошибка?» — рядом с лампочкой: обе кнопки про решение, но эта ступень не сдаёт. */}
            {гдеОшибкаДоступна ? (
              <GameAuxAction
