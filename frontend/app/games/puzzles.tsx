/* psygames-game-puzzles · VER 7 · 17.09.2026 */
/**
  ...
  */
  ...
  const урокДальше = useCallback(async () => {
    ...
    try {
      ...
      for (const н of текущая.карточка.нажатия) последняя = (await нажать(н.x, н.y, н.правой)).партия;
      setПартия(последняя);
      setУрок({ ...урок, индекс: урок.индекс + 1, нажатий: [...урок.нажатий, текущая.карточка.нажатия.length] });
    } finally {
      setУрокЗанят(false);
    }
