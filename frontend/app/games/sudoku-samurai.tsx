...
export default function SamuraiSudokuGame() {
  ...
  const renderConfig = () => (
    ...
    <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.configContainer}>
      ...
      <LevelProgressMap bestLevel={lvl.best} gameId="sudoku_samurai" currentLevel={lvl.level} onPickLevel={lvl.pick} maxLevel={MAX_LEVEL} colors={colors} language={language} />
      <View style={[styles.optionCard, { backgroundColor: colors.surface }]}>
