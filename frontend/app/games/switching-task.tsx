    ...
    return (
      ...
      <ScrollView style={styles.configScroll} contentContainerStyle={styles.configContainer} showsVerticalScrollIndicator={false}>
        <LinearGradient colors={GRADIENT as [string, string]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.configCard}>
          <Ionicons name="swap-horizontal" size={48} color={ON_GRAD.color} />
        ...
        <View style={[styles.optionCard, { backgroundColor: colors.surface }]}>
          ...
          <View style={styles.optionButtons}>
            {MODES.map((m) => (
              <TouchableOpacity
                accessibilityRole="button" key={m.key} style={[styles.modeButton, mode === m.key
        ...
        <LevelProgressMap bestLevel={lvl.best} gameId="switching_task" currentLevel={lvl.level} onPickLevel={lvl.pick} colors={colors} language={language} />
