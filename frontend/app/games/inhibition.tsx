...
// Было зашито '#FFF' — контраст 3.52 (норма AA 4.5), стало 4.51.
  ...
  const renderConfig = () => {
    ...
    return (
      ...
      <ScrollView style={styles.configScroll} contentContainerStyle={styles.configContainer} showsVerticalScrollIndicator={false}>
        ...
        <LevelProgressMap bestLevel={lvl.best} gameId="inhibition" currentLevel={lvl.level} onPickLevel={lvl.pick} colors={colors} language={language} />
...
const styles = StyleSheet.create({
  ...
  goBtnText: { color: ON_GRAD.color, fontSize: 20, fontWeight: '900', letterSpacing: 2 },
});
