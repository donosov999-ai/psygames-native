...
const OBSTACLE_PLANS: ObstaclePlan[] = [
  ...
  // ⚠️ ЗНАКОМСТВО ИДЁТ ПЕРЕД «ДВА ВМЕСТЕ», А НЕ ПОСЛЕ. Эти две строки стояли в
  // обратном порядке, и накрытый товар впервые показывался СРАЗУ С закрытой
  // нишей — прочитать правило по такой доске нельзя, потому что непонятно, к
  // чему оно относится. Поймала проба `goods-sort-obstacles` 06.09.2026.
  { blocked: 0, locked: 0, covered: 3, frozenRow: true },   // L14 накрытые: заморозка тут ещё вычеркнута
