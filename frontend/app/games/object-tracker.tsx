/* psygames-game-object-tracker · VER 3 · 17.09.2026 */
/**
  ...
  if (phase === 'playing') {
    return (
      ...
      <GameShell
        ...
        /**
         * «Заново» пока рисует сам модуль текстовой кнопкой под полем — значка из каркаса не нужно,
         * иначе их два. Когда раздел переведёт свою кнопку в ряд значков каркаса, строку убрать
         * (координатор, правило 17.09.2026: служебное — значками под полем).
         */
        auxRestart={false}
        /**
