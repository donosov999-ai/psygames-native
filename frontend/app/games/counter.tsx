...
const styles = StyleSheet.create({
  ...
  grid: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    // Зазор ОБЯЗАН существовать в стилях, а не только в формуле ширины:
    // клетки без gap забивались в ряд по 11 при 9-колоночной ширине контейнера
    // (332/29,8 = 11) — глаза 07.09 на 360×740; ломалось с любых сеток ≥7
    gap: 8,
    marginBottom: 8,
  },
  cell: {
