...
export const CHESSBLIND_RULES: LevelRule[] = [
  /**
   * ⚠️ ХОДЫ ВСЛЕПУЮ — ПРАВИЛО ВХОДА, А НЕ ПОРОГ (12.09.2026). До этого правило
   * обещало механику с шестого уровня, и это было верно: `BLIND_MOVES` держал нули
   * на первых пяти. Теперь ход стоит на ПЕРВОЙ ступени — дальше 4-го уровня не
   * заходил никто, и механику, ради которой игра названа, не видел ни один игравший.
   * Правило переехало вместе с механикой: оно объясняет, что происходит, с первого
   * же уровня, а порогом больше не является.
   */
  { key: 'moves', fromLevel: 1 },   // lr_chess_blind_moves_*
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.optBtn,
                    {
                      ...
                      /**
                       * 🔴 ПЛАШКА СВЕТЛАЯ У ОБЕИХ СТОРОН — ОТЧЁТ ДЕНИСА 05.09.2026:
                       * «заливка у чёрных шахмат чёрная и фигура сливается с фоном».
                       *
                       * Тёмная плашка под чёрной стороной была верна, пока фигуры
                       * рисовались ТЕКСТОМ: светлый глиф на тёмном читался. С 03.09
                       * фигуры — настоящие картинки Cburnett, где чёрная фигура и
                       * есть чёрная заливка. Чёрный конь на `#1e293b` пропадал.
                       *
                       * Сторону теперь несут РАМКА и сама фигура (у чёрной белый
                       * контур, у белой чёрный), а плашка одинаково светлая — на ней
                       * читаются обе.
                       */
                      backgroundColor: '#e2e8f0',
                      borderColor: рамка ?? (opt.white ? '#94a3b8' : '#0f172a'),
