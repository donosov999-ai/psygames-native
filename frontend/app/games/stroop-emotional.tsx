...
import { ANSWER_BAR_H, BTN_GAP, answerButton, stimBox, ANSWER_BAR_ROW } from '@/src/games/attention/layout';
  ...
  const renderConfig = () => {
    ...
    return (
      ...
      <ScrollView style={styles.configScroll} contentContainerStyle={styles.configContainer} showsVerticalScrollIndicator={false}>
        ...
        <LevelProgressMap bestLevel={lvl.best} gameId="stroop_emotional" currentLevel={lvl.level} onPickLevel={lvl.pick} colors={colors} language={language} />
