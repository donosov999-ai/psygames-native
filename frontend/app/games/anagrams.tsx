...
/**
  ...
  if (phase === 'playing' && режимИгры === 'cross') {
    ...
    return (
      <GameShell pauseActions={действияПаузы} title={t('anagrams')} hud={шапкаРежима} headerActions={шапкаДействий} toolbar={низРежима} bottom="answer" onBack={() => { clearAllTimers(); setPhase('config'); }} confirmExit={armedSquare}>
        {пак ? (
          <CrosswordGame
