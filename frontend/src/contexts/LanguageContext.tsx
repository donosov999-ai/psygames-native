...
const translations: Translations = {
  ...
  lr_switching_task_noise_title: { ru: 'Знаки вокруг стимула', en: 'Symbols around the stimulus' },
  lr_switching_task_noise_rule: { ru: 'Вокруг стимула появляются посторонние знаки. Они ничего не значат — задача та же самая, просто найти нужное труднее.', en: 'Extra symbols appear around the stimulus. They mean nothing — the task is exactly the same, it is just harder to find what matters.' },
  lr_switching_task_noise_example: { ru: 'Пример: к заданию они не относятся. Смотри только на сам стимул.', en: 'Example: they are not part of the task. Look only at the stimulus itself.' },
