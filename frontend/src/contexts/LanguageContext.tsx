...
const translations: Translations = {
  ...
  numberRunLevelsHint: { ru: 'Уровень — 90 секунд. Задачи хаба «Счёт» входят по одной: с 4-го уровня — примеры на арках, с 7-го — «собери ровно N», с 10-го — ряды чисел, с 13-го — шкала. Каждый третий уровень — страж.', en: 'A level lasts 90 seconds. Counting hub tasks join one at a time: problems over arches from level 4, “collect exactly N” from 7, number sequences from 10, the number line from 13. Every third level has a guardian.' },
