...
const translations: Translations = {
  ...
  numberRunLevelsHint: { ru: 'Уровень — 90 секунд. Задачи хаба «Счёт» входят по одной: с 4-го уровня — примеры на арках, с 7-го — «собери ровно N». Каждый третий уровень — страж.', en: 'A level lasts 90 seconds. Counting hub tasks join one at a time: problems over arches from level 4, “collect exactly N” from level 7. Every third level has a guardian.' },
