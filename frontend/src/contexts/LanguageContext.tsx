...
const translations: Translations = {
  ...
  mentalRotationIntroDesc: {
    ru: 'Сверху — эталон, снизу — варианты ответа. В основном задании «Поворот» выбери ту же фигуру, только повёрнутую: остальные варианты — её зеркальное отражение или другая фигура. С уровнем добавляются новые задания: «Проекция», «Развёртка», «Точка зрения», «Одинаковая фигура», «Сборка», «Память», «Три вида», «Срез», «Недостающая часть» и «Сечение»; вопрос каждого написан над эталоном. Тренирует пространственное мышление и мысленное вращение.',
