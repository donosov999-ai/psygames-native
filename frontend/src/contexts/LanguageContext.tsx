...
const translations: Translations = {
  ...
  mentalRotationIntroDesc: {
    ru: 'Сверху — эталон, снизу — варианты ответа. В основном задании «Поворот» выбери ту же фигуру, только повёрнутую: остальные варианты — её зеркальное отражение или другая фигура. С уровнем добавляются новые задания: «Проекция», «Развёртка», «Точка зрения», «Одинаковая фигура», «Сборка», «Три вида», «Срез» и «Недостающая часть»; вопрос каждого написан над эталоном. Тренирует пространственное мышление и мысленное вращение.',
    en: 'The reference is at the top, the answer options below. In the main task, “Rotation”, pick the same shape, just turned: the other options are its mirror image or a different shape. As you level up, new tasks join in: “Projection”, “Cube net”, “Viewpoint”, “Same figure”, “Assembly”, “Three views”, “Slice” and “Missing piece”; each one’s question is written above the reference. Trains spatial reasoning and mental rotation.'
  },
