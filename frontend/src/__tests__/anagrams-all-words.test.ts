...
describe('наборы «найди все слова»', () => {
  it('есть все девять языков, и ни один не пустой', () => {
    /**
     ...
     */
    expect(allWordsLocales()).toEqual(['ar', 'de', 'en', 'es', 'fr', 'it', 'ko', 'pt', 'ru']);
  ...
  it('🔴 язык без своего набора получает английский, а не пустоту', () => {
    // ko и ar с 06.09.2026 имеют свои наборы, поэтому здесь их больше нет
    for (const loc of ['ja', 'zh', 'hi']) {
