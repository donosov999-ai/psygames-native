/* ВРЕМЕННЫЙ ЗОНД ПРОТОКОЛА — не гейт, удалить после ответа. 06.09.2026 */
/**
 ...
 * Мой прогон тем же протоколом, что у `stuck.ts`, дал L28 17 %, L40 27 % — то
 * есть сошёлся со вторым и не сошёлся с первым.
 *
 * Прежде чем объявлять чью-то цифру неверной, надо найти протокол, который даёт
...
/** Один прогон протокола: доля вставших насмерть из N партий. */
