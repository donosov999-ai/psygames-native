 ...
 * ЯПОНСКОЙ — 714 из 1490, то есть почти половина интерфейса шла по-английски.
 * 12.08 вечером погашено 280 ключей (699 → 419, покрытие 54% → 73%): подписи кнопок,
 * названия игр, метки настроек — то, что человек видит в первую очередь. Пятнадцать
