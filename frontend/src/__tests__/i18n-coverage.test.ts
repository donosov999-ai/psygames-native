 ...
 * 12.08 долг погашен ПОЛНОСТЬЮ: 699 → 0, покрытие 54% → 100%. Гасили по частоте
 * показа: сначала подписи кнопок и названия игр, потом польза упражнений и правила,
 * в конце длинные методические вступления и строки с подстановками.
 *
 * ⚠️ Последние 16 ключей я чуть не бросил, решив по своему же разбору, что их нет
 * в английском словаре. Они там были — регулярка спотыкалась о подстановки {n} и
 * типографские кавычки. Проверка глазами дороже уверенности в своём скрипте. Пятнадцать
