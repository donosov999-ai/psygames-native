 ...
 *
 * ⚠️ `sudoku-samurai.tsx` был самым неприятным случаем и ровно тем, ради
 * которого гейт вообще написан: слой партии там уже есть, а вопрос при выходе
 * не задан — значит доска уезжает в хранилище молча. Закрыт 19.08.2026, ушёл в
 * LONG_GAMES. Следом закрыт `set-game.tsx` (оба слоя: и вопрос, и хранение).
 */
