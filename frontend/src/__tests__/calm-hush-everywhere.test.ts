...
const NOT_A_GAME: Record<string, string> = {
  ...
  'spatial-hub.tsx': 'хаб: меню трёх проб на вращение в уме (фигуры, числа, трубы), звука на экране нет',
  'languages-hub.tsx': 'хаб: зонтик над «Словами» и «Слухом», звука на экране нет',
  'inhibition-hub.tsx': 'хаб: меню двух проб на торможение, звука на экране нет',
  'chess-hub.tsx': 'хаб: меню двух шахматных упражнений, звука на экране нет',
  'sorting-hub.tsx': 'хаб: меню двух проб на раскладывание по ёмкостям, звука на экране нет',
  'routes-hub.tsx': 'хаб: меню двух головоломок на покрытие, звука на экране нет',
  'flexibility-hub.tsx': 'хаб: меню трёх проб на переключение признака, звука на экране нет',
};
