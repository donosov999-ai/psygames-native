...
describe('смесь заданий не портит наклон RT по углу', () => {
  ...
  it('🔴 разбивка по видам заданий считается и сходится с числом проб', () => {
    ...
    // 17.09.2026 добавлен formation (задача 0d96f48e), затем section (задача 4f85b6a9), затем memory (задача 69f1810f) и oblique (задача 4f85b6a9).
    expect(taskKindCounts(log)).toEqual({ rotation: 2, projection: 1, net: 1, viewpoint: 0, same: 0, missing: 0, assembly: 0, formation: 0, section: 0, memory: 0, oblique: 0 });
