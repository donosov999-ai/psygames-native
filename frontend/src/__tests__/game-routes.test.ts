...
describe('маршруты игр', () => {
   ...
   * приёмки сразу: семь заходов, правящих их одновременно, затирают друг друга
   * молча. Поэтому экран и его модуль едут отдельным коммитом, а точная строка
   * для `GAMES`, ключи словаря и место в профилях лежат в `INTEGRATION.md`
   * рядом с модулем — их вносит один заход-интегратор, разом и без гонки.
   *
