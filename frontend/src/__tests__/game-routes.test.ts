...
describe('маршруты игр', () => {
  ...
  const AWAITING_CATALOG: Record<string, string> = {
     ...
     */
    'spatial-lab': 'перенос из лаборатории 09.09.2026: готовая строка каталога, четыре ключа словаря и раздел лежат в src/games/spatial-core/INTEGRATION.md — вносит заход-интегратор',
