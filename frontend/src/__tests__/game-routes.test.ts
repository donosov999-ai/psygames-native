...
describe('маршруты игр', () => {
  ...
  const AWAITING_CATALOG: Record<string, string> = {
     ...
     */
    'spatial-lab': 'перенос из лаборатории 09.09.2026: словарь (5 ключей × 12 языков), обложка и заголовок экрана из словаря уже в дереве; карточка ждёт единого стандарта игры (game-standard: usePersistentLevel, LevelProgressMap, общий экран итога, уровень в сессии) — задача раздела «Пространство», текст карточки в src/games/spatial-core/INTEGRATION.md',
