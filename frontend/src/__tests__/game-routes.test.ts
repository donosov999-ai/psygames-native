...
describe('маршруты игр', () => {
  ...
  const AWAITING_CATALOG: Record<string, string> = {
    ...
    'pizza-sort': 'экран, арт, правила и лестница готовы и работают; точная строка для каталога, ключ описания и место в профилях лежат в src/games/cake-sort/INTEGRATION.md — их вносит заход-интегратор, чтобы параллельные правки общего массива не затирали друг друга',
  };
