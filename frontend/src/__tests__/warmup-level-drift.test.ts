 ...
 *
 * Реально роняют уровень в зарядке два экрана: CPT и OSPAN. Они остаются в долге —
 * это правка поведения в живых играх, и она идёт отдельным шагом. Остальные двадцать
 * уезжают из списка без единой правки кода: чинить там было нечего, ошибалась проверка.
 *
 ...
 */
const DEMOTES_IN_WARMUP: string[] = ['cpt.tsx', 'ospan.tsx'];
 ...
 */
const ПО_ПРАВИЛУ = ['spatial-span.tsx'];
