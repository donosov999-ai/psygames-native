...
const styles = StyleSheet.create({
  ...
  numGrid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', gap: 10, marginBottom: 28, alignSelf: 'center', maxWidth: '100%' },
  numCell: { width: 56, height: 56, borderRadius: 12, justifyContent: 'center', alignItems: 'center' },
  numText: { fontSize: 26, fontWeight: '800' },
  opts: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', gap: 12, maxWidth: '100%' },
