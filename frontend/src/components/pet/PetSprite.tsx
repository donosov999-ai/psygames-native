...
export const SKIN_ANCHORS: Record<PetSkin, Record<AnchorName, Anchor>> = {
  ...
  cat:           { head_top: { x: 51.00, y: 28.20, scale: 1.000 }, eyes: { x: 47.02, y: 49.80, scale: 1.000 }, neck: { x: 45.01, y: 62.20, scale: 1.000 } },
  ...
  constellation: { head_top: { x: 49.94, y: 26.40, scale: 0.817 }, eyes: { x: 49.71, y: 53.70, scale: 0.817 }, neck: { x: 49.90, y: 69.30, scale: 0.817 } },
};
