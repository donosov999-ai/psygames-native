...
const SKIN_ANCHORS: Record<PetSkin, Record<AnchorName, Anchor>> = {
  cat:           { head_top: { x: 48.82, y:  6.35, scale: 1.000 }, eyes: { x: 47.02, y: 16.23, scale: 1.000 }, neck: { x: 45.01, y: 24.22, scale: 1.000 } },
  robot:         { head_top: { x: 49.85, y: 25.20, scale: 0.896 }, eyes: { x: 49.90, y: 32.82, scale: 0.896 }, neck: { x: 49.95, y: 39.06, scale: 0.896 } },
  constellation: { head_top: { x: 49.94, y: 10.84, scale: 0.817 }, eyes: { x: 49.71, y: 20.02, scale: 0.817 }, neck: { x: 49.90, y: 27.54, scale: 0.817 } },
};
