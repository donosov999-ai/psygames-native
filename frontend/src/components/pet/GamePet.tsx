 ...
 *
 * ⚠️ 03.09.2026 ОПУЩЕНО ДО ×2 ПО ЖИВОМУ КАДРУ. Денис на скриншоте «Доски в уме»:
 * «рожу питомца надо уменьшить, слишком увеличили». При ×3 в окно попадала только
 * морда без ушей и антенн — питомец переставал узнаваться. ×2 — нижняя граница его
