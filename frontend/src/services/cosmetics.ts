...
export const COSMETICS: Cosmetic[] = [
  { id: 'accent_gold',    type: 'accent', nameRu: 'Золото',  nameEn: 'Gold',    cost: 300, value: '#f5b50a' },
  { id: 'accent_neon',    type: 'accent', nameRu: 'Неон',    nameEn: 'Neon',    cost: 300, value: '#00e5a0' },
  { id: 'accent_ocean',   type: 'accent', nameRu: 'Океан',   nameEn: 'Ocean',   cost: 300, value: '#0aa6ff' },
  { id: 'accent_rose',    type: 'accent', nameRu: 'Роза',    nameEn: 'Rose',    cost: 400, value: '#ff4d8d' },
  { id: 'accent_emerald', type: 'accent', nameRu: 'Изумруд', nameEn: 'Emerald', cost: 500, value: '#10b981' },
];
