...
export interface CardRef {
  ...
  isNew: boolean;
  /**
   * Язык ЭТОЙ карточки. В обычной партии он один на всю сессию и поле не нужно;
   * в режиме билингво карточки двух языков идут вперемешку, и без него оценка
   * ушла бы не в ту колоду, а дистракторы взялись бы из чужого языка.
   */
  lang?: string;
}
