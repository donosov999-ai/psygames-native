 ...
 */
/**
 * ⚠️ ЧЕТЫРЕ ИМЕНИ ПЕРЕИМЕНОВАНЫ 03.09.2026, И НЕ РАДИ КРАСОТЫ. Первый набор дал
 * четыре столкновения со словарём: «Росток» — уже лига, «Компас» — уже рамка в
 * магазине, «Сова» и «Звезда» — уже покупные аватары. Одно слово на трёх носителях
 * путает игрока сильнее, чем непривычное имя фигурки: он видит «Сову» в коллекции,
 * в магазине и в списке рамок и считает, что это одна вещь.
 *
 * Гейт дублей словаря поймал все четыре. Правились ДАННЫЕ, а не храповик исключений:
 * запись «это разные вещи с одним именем» здесь была бы неправдой — они и правда
 * читались как одна.
 */
export const FIGURES: readonly Figure[] = [
  { key: 'Acorn',     at: 150,   face: '🌰' },   // +150
  ...
  { key: 'Anchor',    at: 3260,  face: '⚓' },   // +990  ×1,38
  { key: 'Hourglass', at: 4620,  face: '⏳' },   // +1360 ×1,37
  { key: 'Crystal',   at: 6480,  face: '💎' },   // +1860 ×1,37
  { key: 'Hedgehog',  at: 9030,  face: '🦔' },   // +2550 ×1,37
  { key: 'Moon',      at: 12500, face: '🌙' },   // +3470 ×1,36
  { key: 'Lighthouse',at: 17300, face: '🗼' },   // +4800 ×1,38
] as const;
