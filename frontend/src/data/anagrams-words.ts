// Словарные данные анаграмм, вынесены из компонента app/games/anagrams.tsx (v1.110.0)

/**
 * Each entry: { w: word, h: hint (короткая подсказка-намёк) }
 * Lengths verified — каждое слово точно соответствует категории длины.
 */
export type WordEntry = { w: string; h: string; t?: string };   // t = тема (animals/food/nature/home/transport)

// Темы для выбора. Источник тематических слов — словарь Дениса (anagramWords.json, 1038 слов).
export const ANAGRAM_THEMES: { k: string; emoji: string; ru: string; en: string }[] = [
...
export const RU_WORDS_4: WordEntry[] = [
...
export const RU_WORDS_5: WordEntry[] = [
...
export const RU_WORDS_6: WordEntry[] = [
...
export const EN_WORDS_4: WordEntry[] = [
...
export const EN_WORDS_5: WordEntry[] = [
...
export const EN_WORDS_6: WordEntry[] = [
...
export const RU_WORDS_7: WordEntry[] = [
...
export const RU_WORDS_8: WordEntry[] = [
...
export const EN_WORDS_7: WordEntry[] = [
...
export const EN_WORDS_8: WordEntry[] = [
...
export const RU_WORDS_9: WordEntry[] = [
...
export const EN_WORDS_9: WordEntry[] = [
