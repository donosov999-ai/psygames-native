...
//
// ⚠️ `proofreading` ОТСЮДА УБРАН 06.09.2026. Он попал в список, когда обложкой
// был снимок экрана — плотный абзац текста на 760×1440. Теперь это рисунок
// 160×160 (лист с пометками), спорить с названием карточки нечему, и глушить его
// до 0.1 значит прятать картинку, которую только что нарисовали.
const SUBTLE_IDS = new Set(['story_recall', 'reading_span', 'mnemonics', 'cloze']);
