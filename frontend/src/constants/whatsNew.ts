...
export const WHATS_NEW: WhatsNewEntry[] = [
  ...
  },
  {
    ...
    date: '2026-09-06',
    ru: [
      'Анаграммы: четвёртый режим — «Кроссворд». Слова из того же набора букв вписываются в сетку и пересекаются: найденная буква открывает соседнее слово',
      'Развилка «Сортировка»: «Сортировка товаров» и «Переливалка» теперь в одном месте',
      'Филворды перестали быть квадратными: поле растёт до 12×9, и вытянутые сетки идут дальше восьмого уровня — раньше с тринадцатого выдавалось одно и то же поле',
      'Сортировка товаров: появились полки на один и на четыре товара — раньше на телефоне семь ниш из девяти были тройками',
      'Переливалка: одиннадцатый уровень был легче десятого — вылечено',
      '«Найди все слова» заговорил на семи языках: добавлены немецкий, испанский, французский, итальянский и португальский',
      'Развилки «Языки», «Маршруты» и «Шахматы» открыты во всех профилях',
    ...
    en: [
      'Anagrams: a fourth mode — Crossword. Words from the same letter set go into a grid and cross, so a found letter opens the word beside it',
      'New Sorting hub: Goods Sorting and Water Sort now live in one place',
      'Fillwords are no longer square: the field grows to 12×9 and tall grids continue past level eight — before, level thirteen onward served the very same board',
      'Goods Sorting: shelves for one and for four items — previously seven of nine niches on a phone held three',
      'Water Sort: level eleven used to be easier than level ten — fixed',
      'Find All Words now speaks seven languages: German, Spanish, French, Italian and Portuguese added',
      'The Languages, Routes and Chess hubs are open in every profile',
  ...
  },
  {
    ...
    en: ['New game “Test Tubes” in the Towers hub: pour the colours until each tube holds just one'],
  },
  {
    version: '2.37.51',
    date: '2026-09-05',
