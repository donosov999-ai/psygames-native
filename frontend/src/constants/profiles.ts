...
const FREE: ProfileDef = {
  ...
  allowed_games: [
    ...
    // 🔴 Семья сортировок целиком, а не один «Товары» (09.09.2026, Денис: «пиццу
    // проебал — надо добавить»). Замер по хабу /games/sorting-hub в профиле free:
    // из семи упражнений видны были два (товары + Ханой), потому что остальные пять
    // не стояли НИ В ОДНОМ whitelist — только у профилей с allowed_games: 'all'.
    // Открываем вместе с товарами: правило игры одно (ёмкость), разная только еда.
