 ...
 * сорок восемь уровней означали тридцать шесть сгенерированных. Набор вырос до
 * сорока — и генератору осталось ВОСЕМЬ уровней, то есть расти ему негде: точки
 * прибавляются раз в три уровня, а трёх шагов не хватает даже на один заметный
 * рост. Игра-образец обещает тысячи уровней; восемьдесят — скромно, но это
 * сорок сгенерированных сверх рисованных, где лестница действительно работает.
 */
export const LEVELS = 80;
